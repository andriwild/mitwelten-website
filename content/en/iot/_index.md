  ...
  <div class="row">
    ...
    <div class="col-md-3 col-sm-6 mb-5 mb-lg-0 d-flex flex-column text-center flex-grow-1 d-flex align-items-center justify-content-center">
      ...
      {{< figure src="/mitwelten-website/images/iot/IOT_Reference.png" 
                    ...
                    width="100%" >}}
            <p style="min-height: 150px">
        The <a href="/mitwelten-website/docs/MW_Software_Environment.pdf" 
                        target="_blank">
                        PDF document
                    </a> 
                    describes the software environment developed together with the IoT Toolkit, including services, storage infrastructure, web applications and mobile applications.
                </p>
    </div>
  </div>
</div>
