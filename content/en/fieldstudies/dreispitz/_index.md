...
<div class="row align-items-start px-0 gx-5">
    <div class="col-md-6">
        <!-- TODO : figcatption -->
        <figure>
            <img src="/mitwelten-website/images/fieldstudies/illustration_1.jpeg" width="100%" alt="Interactive outdoor installation. Summer 2024, campus of the FHNW Academy of Art and Design.">
...
<div class="container mt-5 mb-5">
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 mb-5 mb-lg-0 d-flex flex-column text-center">
            <a class="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover flex-grow-1 d-flex align-items-center justify-content-center"
            ...
            {{< figure src="/mitwelten-website/images/interventions/ecosystem/HumanPresence_card.jpg"
                ...
                width="100%" 
                class="mt-2" >}}
                <p style="min-height: 100px">Bird Diversity, Pollinator Diversity, Human Presence</p>
        </div>
        <div class="col-md-3 col-sm-6 mb-5 mb-lg-0 d-flex flex-column text-center">
            <a class="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover flex-grow-1 d-flex align-items-center justify-content-center"
            ...
            {{< figure src="/mitwelten-website/images/applications/panorama_card.jpg"
                ...
                width="100%" 
                class="mt-2" >}}
                <p style="min-height: 100px">Discover, WildCam TV</p>
        </div>
        <div class="col-md-3 col-sm-6 mb-5 mb-lg-0 d-flex flex-column text-center">
            <a class="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover flex-grow-1 d-flex align-items-center justify-content-center"
            ...
            {{< figure src="/mitwelten-website/images/interventions/interspecies_plattform/InterspeciesOutdoorFurniture.jpg"
                ...
                width="100%" 
                class="mt-2" >}}
                <p style="min-height: 100px">Interspecies Outdoor Furniture, Hacked Infrastructures, Stepping Stone Habitats</p>
        </div>
        <div class="col-md-3 col-sm-6 mb-5 mb-lg-0 d-flex flex-column text-center">
            <a class="link-light link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover flex-grow-1 d-flex align-items-center justify-content-center"
            ...
            {{< figure src="/mitwelten-website/images/interventions/participatory_installations/Leitsystem.jpg"
                ...
                width="100%" 
                class="mt-2" >}}
                <p style="min-height: 100px">Sensing with trees</p>
        </div>
    </div>
</div>
