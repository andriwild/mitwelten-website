...
<div class="row align-items-start">
    <div class="col-md-6 align-items-end">
    <h4 class="text-end">Situation and ecological challenge</h4>
    <p class="text-end">
...
<h4 class="text-end">Media-ecological approach</h4>
<p class="text-end">
...
A more detailed description of the medium and the findings are presented in the publication <strong>'Mitwelten. Media-ecological Design Strategies for Improving Peri Urban Biodiversity'</strong>. (Coming soon!)
    ...
    <div class="col-md-6">
        <figure>
	        ...
	        <figcaption><p style="font-size:11px;">Atlas-based online information platform for the public</p></figcaption>
        </figure>
    </div>
</div>
...
<div class="mx-auto" style="width: 90%">
  <h3 class="text-center">Wild Cam TV</h3>
