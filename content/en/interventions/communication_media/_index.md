...
<div class="row align-items-start px-0 gx-5">
    <div class="col-xl-6">
        <figure>
            ...
            <figcaption><p class="text-end">GPS-based outdoor information app</p></figcaption>
        </figure>
    </div>
...
<div class="row align-items-start px-0 gx-5">
    ...
    <div class="col-md-6">
        <figure>
            ...
            <figcaption><p>Atlas-based online information platform for the public</p></figcaption>
        </figure>
    </div>
</div>
...
<div class="row align-items-start px-0 gx-5">
    <div class="col-md-6">
        <figure>
            ...
            <figcaption><p class="text-end">3D image-based online publishing format</p></figcaption>
        </figure>
    </div>
    <div class="col-md-6 align-items-end">
        <h4>Situation and ecological challenge</h4>
    ...
    <div class="row align-items-start px-0 gx-5">
        ...
        <div class="col-md-6">
            <figure>
                ...
                <figcaption><p>Cinematic interactive exhibition platform. Exhibited at “Civic” during the “MESH Festival”, September 23 - October 20, 2024.</p></figcaption>
            </figure>
        </div>
    </div>
</div>
