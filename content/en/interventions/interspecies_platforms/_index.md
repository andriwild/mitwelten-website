...
<div class="row align-items-start">
    <div class="col-md-6">
        <figure>
	        ...
	        <figcaption><p style="font-size:11px; text-align:right;">2023 | FHNW campus Brugg/Windisch | semester project ‘SociaLandscapes’, collaboration with the HGK BA Interior Architecture and Scenography</p></figcaption>
        </figure>
    </div>
...
<h4 class="text-end">Key Concepts</h4>
<p class="text-end">
...
A more detailed description of the carried out actions, implemented prototypes and the teaching units are presented in the publication <strong>'Mitwelten. Media-ecological Design Strategies for Improving Peri Urban Biodiversity'</strong>. (Coming soon!)
    ...
    <div class="col-md-6">
        <figure>
	        ...
	        <figcaption><p style="font-size:11px;">2023 | Basel Academy of Art and Design FHNW | educational unit ‘CoCreate’</p></figcaption>
        </figure>
    </div>
</div>
...
<div class="row align-items-start">
    <div class="col-md-6">
        <figure>
	        ...
	        <figcaption><p style="font-size:11px; text-align:right;">2023 | Campus of the Basel Academy of Art and Design FHNW | concepts and student projects</p></figcaption>
        </figure>
    </div>
    <div class="col-md-6 align-items-end">
    <h4>Situation and ecological challenge</h4>
