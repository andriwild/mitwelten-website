...
{{% blocks/feature icon="fa-eye" title="KONZEPTION" %}}
Interspecies Contact Zones – Ontodiversität – Topologie

{{< figure src="/images/iscz_map.png" text="Interspecies Contact Zones"  width="90%" >}}
{{% /blocks/feature %}}


{{% blocks/feature icon="fa-edit" title="FORSCHUNGSANSATZ" %}}
Medienökologie – Empirische Analyse – Datenvisualisierung
{{< figure src="/images/pollinators.jpg" text="Pollinators"  width="90%" >}}
{{% /blocks/feature %}}


{{% blocks/feature icon="fa-globe" title="IOT TOOLKIT" %}}
Backend & Netzwerk – Sensoren Hard- & Software – Web Map

{{< figure src="/images/webmap_vermittlung.png" text="WebMap"  width="90%" >}}
{{% /blocks/feature %}}
...
{{% blocks/feature icon="fa-eye" title="BIRD DIVERSITY" %}}
Vögel  

{{< figure src="/images/birddiversity.png" text="Bird Diversity"  width="90%"  >}}
{{% /blocks/feature %}}


{{% blocks/feature icon="fa-edit" title="POLLINATORS" %}}
Blütenbesucher  
...
__Abstract:__  
Im Rahmen des SNF-Forschungsprojektes «Mitwelten» wurden «Bestäuberexperimente» durchgeführt. Es wurden Kamerafallen (Blumentöpfe mit Kameras) an verschiedenen Orten in den Merian Gärten aufgestellt, um Bestäuber anzulocken, Fotos aufzunehmen und anschliessend mit Künstlicher Intelligenz (KI) Morphospezies zu bestimmen.   
  

{{% /blocks/feature %}}


{{% blocks/feature icon="fa-globe" title="ONTODIVERSITY" %}}
Medienökologische Feldforschung  
...
{{< blocks/section >}}
<div class="col-12">
<h1 class="text-center">Weiterer Abschnitt Titel</h1>
</div>
<p class="text-center">Mehr Text ...</p>
{{< /blocks/section >}}
-->
